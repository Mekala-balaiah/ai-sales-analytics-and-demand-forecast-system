...
const COLORS = ['#64ffda', '#b388ff', '#58a6ff', '#00e676', '#ff5252', '#ffd700', '#ff9800'];
                    ...
                    <div style={{ height: '350px' }}>
                        <ResponsiveContainer>
                            <PieChart>
                                ...
                                <Tooltip formatter={(value) => formatCurrency(value)} contentStyle={{ background: 'var(--panel-bg)', borderColor: 'var(--border-color)', borderRadius: '8px', color: '#fff' }} />
